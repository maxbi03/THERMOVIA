...
/**
 * Page panier V1 : liste des articles (état local), total indicatif.
...
export default function PanierPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      <h1 className="text-3xl font-bold text-anthracite">Votre panier</h1>
        ...
        <>
            ...
            {lignes.map(({ item, product }) => (
              <li key={item.productId} className="flex flex-wrap items-center gap-4 p-4">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm text-zinc-500">{formatPrice(product!.price)} / pièce</p>
                </div>
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <p className="text-lg font-bold text-anthracite">
              ...
              <span className="block text-right text-xs font-normal text-zinc-500">TVA incluse</span>
            </p>
          </div>
          ...
          <div className="mt-8 rounded-xl bg-zinc-50 p-6 text-center">
            <p className="text-sm text-zinc-600">
              Le paiement en ligne (TWINT, carte, PostFinance) sera activé avec le catalogue
              définitif. En attendant, validez votre sélection en demande de devis : nous
              vous confirmons prix, disponibilité et délais par e-mail.
            </p>
            <Link
