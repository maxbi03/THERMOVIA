 ...
 * station officielle de l'agglomération lausannoise — Lausanne parle à plus
 * de monde que Vevey, même si le stock part de la Riviera. Le fichier « _now »
 * contient les valeurs toutes les 10 minutes du jour courant ; on lit la
 * dernière ligne renseignée, la plus récente étant souvent incomplète.
 *
...
export function formatMeasuredAt(date: Date, localeTag = "fr-CH"): string {
